package net.thesilkminer.skl.interpreter.sks.components.decisionals;
...
import net.thesilkminer.skl.interpreter.sks.IllegalScriptException;
...
public class IfDeclaration implements ILanguageComponent {
	...
	private boolean testSpecifiedCondition() {
		...
		net.thesilkminer.skl.interpreter.sks.SksLogger.logger().warn("Boolean property "
